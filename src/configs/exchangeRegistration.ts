export default [
  ...
  { name: 'CoinW', url: 'https://www.coinw.com/front/invitePublicity?r=2661579&language=en_US' },
  { name: 'XT.com', url: 'https://www.xt.com/en/accounts/register?ref=HAJQCH' },
  { name: 'OKX', url: 'https://okx.com' },
  { name: 'Bitmart', url: 'https://www.bitmart.com/register-referral/en?r=VSACBD' },
